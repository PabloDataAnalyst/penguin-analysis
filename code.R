...
Descubrir si el tamaño del pico (bill_length_mm) y el peso (body_mass_g) varían según la especie y la isla.
...
# Importar dataset en caso de que sea necesario y cargarlo
View(penguins)
